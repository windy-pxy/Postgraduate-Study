...
知识点放在各学科目录或 `03-Knowledge-Notes`；错题、真题、测试、薄弱点、学习记录分别放在对应编号目录。资料笔记放在 `90-Parsed-Sources`，它们是可核对的派生笔记，绝不是原件。所有 Markdown 使用 UTF-8，正式笔记以 `---` 包围 YAML frontmatter。
...
入口：[[00-System/Home|首页]] · [[00-System/Linking-Rules|双链规范]] · [[00-System/Validation-Guide|验证说明]]
